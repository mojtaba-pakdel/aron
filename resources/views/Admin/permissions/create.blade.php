...
@section('title-meta')
    ...
    <meta name="description" content=" ایجاد دسترسی جدید">
@endsection
@section('content')
    <!-- begin:: Content -->
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form kt-form--label-right" action="{{route('permissions.store')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="kt-portlet__body">
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <label>نام:</label>
                                    <input type="text" name="name" class="form-control" value="{{old('name')}}" placeholder="نام دسترسی را وارد کنید ">
                                    <span class="form-text text-muted">نام دسترسی را وارد کنید</span>
                                </div>
                                <div class="col-lg-6">
                                    <label>توضیحات:</label>
                                    <input type="text" name="label" class="form-control" value="{{old('label')}}" placeholder="توضیحات این دسترسی را وارد کنید ">
                                    <span class="form-text text-muted">توضیحات این دسترسی را وارد کنید</span>
                                </div>
                            </div>
                        </div>
