...
@section('title-meta')
    ...
    <meta name="description" content="ایجاد مقام کاربران">
@endsection
@section('content')
    <!-- begin:: Content -->
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form kt-form--label-right" action="{{route('level.store')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="kt-portlet__body">
                            <div class="form-group row">
                                <div class=" col-lg-12 col-md-12 col-sm-12">
                                    <label >کاربر</label>
                                    <select class="form-control kt-select2" dta-live-search="true" id="kt_select2_4" name="user_id" >
