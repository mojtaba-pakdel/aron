                        ...
                        @if(count($role->users))
                            @foreach($role->users as $user)
                                <tr class="row_{{$user->id}}">
                                    ...
                                    <td>
                                        <a href="{{route('level.edit',['user'=>$user->id])}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="View">
                                            <i class="la la-edit"></i>
                                        </a>
                                        <button type="button" data-model="level" data-id="{{$role->id}}" class="btn  btn-custom kt_sweetalert_demo_9">  <i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
                            @endforeach
                        @endif
