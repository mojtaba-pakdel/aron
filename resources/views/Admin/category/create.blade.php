...
@section('title-meta')
    ...
    <meta name="description" content="ایجاد دسته بندی جدید">
@endsection
@section('content')
    <!-- begin:: Content -->
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form kt-form--label-right" action="{{route('categories.store')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="kt-portlet__body">
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <label>عنوان:</label>
                                    <input type="text" name="title" class="form-control" value="{{old('title')}}" placeholder="عنوان دسته بندی را وارد کنید ">
                                    <span class="form-text text-muted">عنوان دسته بندی را وارد کنید</span>
                                </div>
                                <div class=" col-lg-6 col-md-6 col-sm-12">
                                    <label> والد:</label>
                                    <select class="form-control " id="kt_select2_3" name="parent_id" >
                            ...
                            <div class="form-group row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="kt-input-icon">
                                        <textarea name="description" class="form-control" placeholder="خلاصه مطلب">{{old('description')}}</textarea>
                                    </div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="kt-input-icon">
                                        <textarea name="body" class="form-control" placeholder="متن کامل">{{old('body')}}</textarea>
                                    </div>
