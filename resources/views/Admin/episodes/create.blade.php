...
@endsection
@section('title-meta')
    <title>ایجاد آموزش</title>
    <meta name="description" content="ایجاد فایل آموزشی">
@endsection
@section('content')
    <!-- begin:: Content -->
                    ...
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">
                               ایجاد قسمت های آموزش
                            </h3>
                        </div>
                    </div>

                    <!--begin::Form-->
                    <form class="kt-form kt-form--label-right" action="{{route('episodes.store')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="kt-portlet__body">
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <label>عنوان:</label>
                                    <input type="text" name="title" class="form-control" value="{{old('title')}}" placeholder="عنوان قسمت را وارد کنید ">
                                    <span class="form-text text-muted">عنوان قسمت را وارد کنید</span>
                                </div>
                                ...
                                <div class=" col-lg-3 col-md-3 col-sm-12">
                                    ...
                                    <select class="form-control kt-select2" id="kt_select2_3" name="course_id">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" name="number" class="form-control" placeholder="شماره قسمت  را وارد کنید" value="{{old('number')}}">
                                </div>
                                <div class="col-lg-3">
                                    <label>زمان:</label>
                                    <input type="text" name="time" class="form-control" placeholder="مدت زمان این قسمت  را وارد کنید" value="{{old('time')}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-6">
