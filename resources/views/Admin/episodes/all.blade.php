...
@endsection
@section('title-meta')
    <title>لیست ویدئو ها</title>
    <meta name="description" content="لیست ویدئو های آموزشی">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                    ...
                    <tr class="row_{{$episode->slug}}">
                        <td>{{$episode->id}}</td>
                        <td><a href="#">{{$episode->title}}</td>
                        ...
                        <td>{{verta($episode->created_at)}}</td>
                        <td>{!!  $episode->status == 1 ? "<span class=\"btn\">انتشار</span>":"<span class=\"btn\">عدم انتشار</span>"!!}</td>
                        <td>
                            <a href="{{route('episodes.edit',['episode'=>$episode->slug])}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="View">
                                <i class="la la-edit"></i>
                            </a>
                            <button type="button" data-model="episodes" data-id="{{$episode->slug}}" class="btn  btn-custom kt_sweetalert_demo_9">  <i class="fa fa-trash"></i></button>
                        </td>
                    </tr>
                        @endforeach
                    </tbody>
