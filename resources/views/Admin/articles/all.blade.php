...
@endsection
@section('title-meta')
    <title>آرشیو محتوا</title>
    <meta name="description" content="لیست مقالات وارد شده در سایت">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                    ...
                    <tr class="row_{{$article->slug}}">
                        <td>{{$article->id}}</td>
                        <td><a href="{{ $article->path() }}">{{$article->title}}</td>
                        <td>{{$article->commentCount}}</td>
                        <td>{{$article->viewCount}}</td>
                        <td>{{$article->user->name}}</td>
                        <td>{{verta($article->created_at)}}</td>
                        <td>{!!  $article->status == 1 ? "<span class=\"btn\">انتشار</span>":"<span class=\"btn\">عدم انتشار</span>"!!}</td>
                        <td>
                            <a href="{{route('articles.edit',['article'=>$article->slug])}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="View">
                                <i class="la la-edit"></i>
                            </a>
                            <button type="button" data-model="articles" data-id="{{$article->slug}}" class="btn  btn-custom kt_sweetalert_demo_9">
